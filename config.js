...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "DML-MD~fY13CZxR#Zx19wffgd-QzjKqrBY4LzZjnNYTvTHACk8ZSzXqJ6AE",
// add your Session Id 
...
OWNER_NAME: process.env.OWNER_NAME || "DML-BRIAN",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© POWERED BY BRIAN*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/vcdwmp.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *BN-MD*⚡",
// add alive msg here 
